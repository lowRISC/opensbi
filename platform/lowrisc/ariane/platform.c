...
#define ARIANE_HART_STACK_SIZE			8192

#define ARIANE_SYS_CLK				50000000

#define ARIANE_CLINT_ADDR			0x2000000

#define ARIANE_PLIC_ADDR			0xc000000
#define ARIANE_PLIC_NUM_SOURCES			0x20
#define ARIANE_PLIC_NUM_PRIORITIES		7

#define ARIANE_UART_ADDR			0x10000000
#define ARIANE_UART_BAUDRATE			115200
#define ARIANE_UART_SHIFTREG_ADDR		50000000
...
static int platform_console_init(void)
{
	...
	return uart8250_init(ARIANE_UART_ADDR,
			     ARIANE_UART_SHIFTREG_ADDR,
			     ARIANE_UART_BAUDRATE, 2, 1);
}
...
const struct sbi_platform platform = {
	...
	.name = "ariane",
	.features = SBI_PLATFORM_DEFAULT_FEATURES&~SBI_PLATFORM_HAS_PMP,
	.hart_count = 1,
